  ...
  async function generateContent() {
    ...
    try {
      const response = await axios.post('https://api.openai.com/v1/engines/text-davinci-003/completions', {
        prompt: `Using the description provided, create a rhyming children's story divided into 10 sections or pages with only 2 rhyming sentences per page. The description is as follows:\n\n${prompt}\n\nSection 1: (Page 1)\n[Generate 2 rhyming sentences for Page 1]\n\nSection 2: (Page 2)\n[Generate 2 rhyming sentences for Page 2]\n\nSection 3: (Page 3)\n[Generate 2 rhyming sentences for Page 3]\n\nSection 4: (Page 4)\n[Generate 2 rhyming sentences for Page 4]\n\nSection 5: (Page 5)\n[Generate 2 rhyming sentences for Page 5]\n\nSection 6: (Page 6)\n[Generate 2 rhyming sentences for Page 6]\n\nSection 7: (Page 7)\n[Generate 2 rhyming sentences for Page 7]\n\nSection 8: (Page 8)\n[Generate 2 rhyming sentences for Page 8]\n\nSection 9: (Page 9)\n[Generate 2 rhyming sentences for Page 9]\n\nSection 10: (Page 10)\n[Generate 2 rhyming sentences for Page 10]`,
        max_tokens: 2048,
        n: 1,
      }
        , {
